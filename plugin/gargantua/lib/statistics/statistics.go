...
import (
	...
	"github.com/sniperkit/gargantua/lib/worker"
)
...
func UpdateStatistics(workResult worker.WorkResult) {
...
func (statistics *Statistics) Add(workResult worker.WorkResult) Snapshot {
